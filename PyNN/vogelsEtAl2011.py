...
eta = 1e-4
eta *= weightInhibToInhibSynapses  # weight of inhibitory to excitatory synapses
rho = 0.003
...
## Fig. 4, D
##
##  Inhibitory plasticity has successfully suppressed any elevated activity
...
##  of the network, including the other pattern, remains nearly unaffected
##  Original simulation time: 5 sec (5000 ms)
